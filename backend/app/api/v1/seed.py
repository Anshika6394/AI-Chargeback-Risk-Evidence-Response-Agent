...
def seed_database(
    ...
    """Seed deterministic synthetic demo data in development only."""
    if settings.app_env != "development":
        raise HTTPException(status_code=status.HTTP_403_FORBIDDEN, detail="Seeding is only available in development")
